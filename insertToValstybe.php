...
foreach ($countries as $country) {
	...
	echo $viskas;
	echo "</br>";
	$query="INSERT INTO `valstybe` (`id_Valstybe`, `zemynas`, `gyventoju_sk`, `pavadinimas`, `laiko_zona`, `ikurimo_data`) VALUES ('".$id."', '".$country['continent']."', '".rand(1000000,10000000)."', '".$country['country']."', '".rand(0,5)."', '".$viskas."');";
